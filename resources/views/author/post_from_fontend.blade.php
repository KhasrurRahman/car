                ...
                @if ($post->count() == 0)
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                                You Call Post Your 1St Advertise for free which is expired after 90 days And This Post Will be categorized under ordinary category
                            </h2>
                        </div>
