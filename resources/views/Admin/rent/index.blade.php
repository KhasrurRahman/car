                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($posts as $key=>$post)
                                    <tr>
                                        ...
                                        <th>{{$post->company_name}}</th>
                                        <th><img class="img-responsive thumbnail"
                                                 src="{{ url('storage/app/public/company_logo/'.$post->company_logo) }}"></th>
                                        <td>{{$post->Colour}}</td>
                                        ...
                                        <td><img class="img-responsive thumbnail"
                                                 src="{{ url('storage/app/public/rent/'.$post->image_1) }}"></td>
                                        <td><img class="img-responsive thumbnail"
                                                 src="{{ url('storage/app/public/rent/'.$post->image_2) }}"></td>
                                        <td><img class="img-responsive thumbnail"
                                                 src="{{ url('storage/app/public/rent/'.$post->image_3) }}"></td>
                                        <td><img class="img-responsive thumbnail"
                                                 src="{{ url('storage/app/public/rent/'.$post->image_4) }}"></td>
                                        <td><img class="img-responsive thumbnail"
                                                 src="{{ url('storage/app/public/rent/'.$post->image_5) }}"></td>
